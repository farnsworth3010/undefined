...
def xlsToMysql():
    connect = mysql.connector.connect(host="localhost", user="root", password="Rostik3015", database="stdtest", auth_plugin='mysql_native_password') # Подключение к базе данных

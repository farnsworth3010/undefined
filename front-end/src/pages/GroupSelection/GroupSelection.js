  ...
  render(){
    if(this.props.group_id>=0){
      ...
      return <Navigate to={link}/>
        ...
        {/* <h1>Курс 2 🤖</h1> */}
        {/* <Link to={'/VSUschedule/schedule/20'} onClick={()=>{this.props.selectGroup(10)}}><div className={s.button}>22ИСИТ1д</div></Link>
        <Link to={'/VSUschedule/schedule/21'} onClick={()=>{this.props.selectGroup(21)}}><div className={s.button}>22КБ1д</div></Link>
        <Link to={'/VSUschedule/schedule/22'} onClick={()=>{this.props.selectGroup(22)}}><div className={s.button}>22ПИ_ВЕБ1д</div></Link>
        <Link to={'/VSUschedule/schedule/23'} onClick={()=>{this.props.selectGroup(23)}}><div className={s.button}>22ПИ_ПОКС1д</div></Link>
        <Link to={'/VSUschedule/schedule/24'} onClick={()=>{this.props.selectGroup(24)}}><div className={s.button}>22ПМ1д</div></Link>
        <Link to={'/VSUschedule/schedule/25'} onClick={()=>{this.props.selectGroup(25)}}><div className={s.button}>22ПОИТ1д</div></Link>
        <Link to={'/VSUschedule/schedule/26'} onClick={()=>{this.props.selectGroup(26)}}><div className={s.button}>22УИР1д</div></Link> */}
{/* 
        <h1>Курс 3 💻</h1>
